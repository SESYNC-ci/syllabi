...
|           |    10:00 | Individual project consultation and work time                                                                         |
|           |    *10:30* | *Break*                                                                                                                                                                                                                                                       |
...
|           |       9:00 | Choice of Tutorial: Tutorial: [Programming in NetLogo][6] OR [Use R to analyze NetLogo simulations][9]                                                                                                                                                                                                          |
|           |    *10:30* | *Break*                                                                                                                                                                                                                                                       |
