...
|           |       9:45 | Lecture: [Introduction to spatially-explicit ABMs, part 1][5]                                                                                                                                                                                                  |
|           |    *10:30* | *Break*                                                                                                                                                                                                                                                       |
|           |      11:00 | Lecture: [Introduction to spatially-explicit ABMs, part 2][5]                                                                                                                                                                                                 |
|           | *12:30 pm* | *Lunch*                                                                                                                                                                                                                                                       |
|           |       1:30 | Tutorial: [Programming in NetLogo][6]                                                                                                                                                                                                                         |
|           |     *3:30* | *Break*                                                                                                                                                                                                                                                       |
|           |       3:45 | Tutorial: [Introduction to Code Versioning with Git][7]                                                                                                                                                                                                       |
|           |       5:00 | Day wrap-up                                                                                                                                                                                                                                                   |
...
|           |       9:00 | Class discussion of writing assignments                                                                                                                                                                                                                       |
|           |    10:00 | Brief overview of ODD protocol                                                                                                                                                                                                                                                       |
|           |    *10:30* | *Break*                                                                                                                                                                                                                                                       |
...
|           |       9:00 | Tutorial: [Use R to analyze NetLogo simulations][9]                                                                                                                                                                                                          |
|           |    *10:30* | *Break*                                                                                                                                                                                                                                                       |
...
[6]: {{ site.gh-pages }}/netlogo-programming-lesson/class
[7]: {{ site.gh-pages }}/basic-git-lesson/class
[8]: https://drive.google.com/open?id=1TycMtH7E5RdGvytUn1ri8agEN5HbFSIHBGamuBaNy-M
[9]: {{ site.gh-pages }}/rnetlogo-lesson/class
[10]: {{ site.gh-pages }}/gis-abm-lesson/class
