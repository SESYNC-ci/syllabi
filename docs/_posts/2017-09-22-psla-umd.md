...
Please review the agenda below and follow [**pre-arrival installation instructions**](#pre-arrival-installation-instructions).
...
|     1:30 | *Visualization in a Grammar of Graphics |
|     3:30 | *Stretch Break*                         |
