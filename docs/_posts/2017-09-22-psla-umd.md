...
[Basic R]: {{ site.gh-pages }}/basic-R-lesson/2017/09/22/
[tidy Data and dplyr Transformations]: {{ site.gh-pages }}/data-manipulation-in-R-lesson/2017/09/22/
[Visualizations with ggplot2]: {{ site.gh-pages }}/graphics-with-ggplot2-lesson/2017/09/22/
[From Data to Document in RMarkdown]: {{ site.gh-pages }}/basic-RMarkdown-lesson/2017/09/22/
